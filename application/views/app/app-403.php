...
<head>
    ...
    <title><?=SITENAME?> - Access Denied</title>
    ...
    <div id="appCapsule">
        ...
        <div class="section">
            <div class="splash-page mt-5 mb-5">
                ...
                <h2 class="mb-2">You Don't Have Permission To View This Page</h2>
                <h3 class="mb-2">🚫🚫🚫🚫</h3>
                <h4 class="mb-2 text-primary" style="text-decoration: underline;">Error code:403 Forbidden</h4>
            </div>
        </div>
